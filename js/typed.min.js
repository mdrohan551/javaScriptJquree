            ...
            var i = function () {
                ...
                a = function () {
                    ...
                    return i(t, [{
                            ...
                            key: "start",
                            value: function () {
                                this.typingComplete || this.pause.status && (this.pause.status = !1, this.pause.typewrite ?
                                    this.typewrite(this.pause.curString, this.pause.curStrPos) :
                                    this.backspace(this.pause.curString, this.pause.curStrPos), this.options.onStart(this.arrayPos, this))
                            }
                        }, {
                            key: "destroy",
                            value: function () {
                            ...
                            value: function (t, e) {
                                ...
                                this.fadeOut && this
                                    .el
                                    .classList
                                    .contains(this.fadeOutClass) && (this.el.classList.remove(this.fadeOutClass), this.cursor && this.cursor.classList.remove(this.fadeOutClass));
                            ...
                            value: function (t, e) {
                                ...
                                this
                                    .options
                                    .onStringTyped(this.arrayPos, this),
                            ...
                            value: function (t, e) {
                                ...
                                this.timeout = setTimeout(function () {
                                    ...
                                    e > s.stopNum ?
                                        (e--, s.backspace(t, e)) :
                                        e <= s.stopNum && (s.arrayPos++, s.arrayPos === s.strings.length ?
                                            (s.arrayPos = 0, s.options.onLastStringBackspaced(), s.shuffleStringsIfNeeded(), s.begin()) :
                            ...
                            value: function () {
                                this
                                    ...
                                    .onComplete(this),
                                    this.loop ?
                                    this.curLoop++ : this.typingComplete = !0
                            }
                        }, {
                            key: "setPauseStatus",
                            value: function (t, e, s) {
                    ...
                    return o(t, [{
                            ...
                            value: function (t, e, s) {
                                if ("string" == typeof s ?
                                    ...
                                    t.el = s, t.options = r({}, u["default"], e), t.isInput = "input" === t.el.tagName.toLowerCase(), t.attr = t.options.attr, t.bindInputFocusEvents = t.options.bindInputFocusEvents, t.showCursor = !t.isInput && t.options.showCursor, t.cursorChar = t.options.cursorChar, t.cursorBlinking = !0, t.elContent = t.attr ?
                                    ...
                                    var n = Array
                                        .prototype
                                        .slice
                                        .apply(t.stringsElement.children),
                                        i = n.length;
                                    if (i)
                                        for (var o = 0; o < i; o += 1) {
                                            var a = n[o];
                            ...
                            value: function (t) {
                                ...
                                if (t.autoInsertCss && (t.showCursor || t.fadeOut) && !document.querySelector("[" + e + "]")) {
                                    ...
                                    var n = "";
                                    t.showCursor && (n += "\n        .typed-cursor{\n          opacity: 1;\n        }\n        .typed-curso" +
                                            "r.typed-cursor--blink{\n          animation: typedjsBlink 0.7s infinite;\n      " +
                                            "    -webkit-animation: typedjsBlink 0.7s infinite;\n                  animation:" +
                                            " typedjsBlink 0.7s infinite;\n        }\n        @keyframes typedjsBlink{\n     " +
